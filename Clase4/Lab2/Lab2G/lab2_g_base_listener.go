...
// EnterE_String is called when production E_String is entered.
func (s *BaseLab2_GListener) EnterE_String(ctx *E_StringContext) {}

// ExitE_String is called when production E_String is exited.
func (s *BaseLab2_GListener) ExitE_String(ctx *E_StringContext) {}

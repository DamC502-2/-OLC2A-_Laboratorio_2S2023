...
func lab2_gParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		4, 1, 4, 1, 4, 1, 4, 1, 4, 3, 4, 58, 8, 4, 1, 4, 1, 4, 1, 4, 1, 4, 1, 4,
		1, 4, 5, 4, 66, 8, 4, 10, 4, 12, 4, 69, 9, 4, 1, 4, 0, 1, 8, 5, 0, 2, 4,
		6, 8, 0, 3, 1, 0, 3, 4, 2, 0, 5, 5, 10, 10, 2, 0, 3, 3, 6, 6, 77, 0, 10,
		1, 0, 0, 0, 2, 15, 1, 0, 0, 0, 4, 37, 1, 0, 0, 0, 6, 45, 1, 0, 0, 0, 8,
		57, 1, 0, 0, 0, 10, 11, 3, 2, 1, 0, 11, 1, 1, 0, 0, 0, 12, 14, 3, 4, 2,
		0, 13, 12, 1, 0, 0, 0, 14, 17, 1, 0, 0, 0, 15, 13, 1, 0, 0, 0, 15, 16,
		1, 0, 0, 0, 16, 3, 1, 0, 0, 0, 17, 15, 1, 0, 0, 0, 18, 19, 5, 12, 0, 0,
		19, 20, 5, 8, 0, 0, 20, 25, 3, 8, 4, 0, 21, 22, 5, 1, 0, 0, 22, 24, 3,
		8, 4, 0, 23, 21, 1, 0, 0, 0, 24, 27, 1, 0, 0, 0, 25, 23, 1, 0, 0, 0, 25,
		26, 1, 0, 0, 0, 26, 28, 1, 0, 0, 0, 27, 25, 1, 0, 0, 0, 28, 29, 5, 7, 0,
		0, 29, 38, 1, 0, 0, 0, 30, 31, 5, 11, 0, 0, 31, 34, 5, 16, 0, 0, 32, 33,
		5, 9, 0, 0, 33, 35, 3, 8, 4, 0, 34, 32, 1, 0, 0, 0, 34, 35, 1, 0, 0, 0,
		35, 38, 1, 0, 0, 0, 36, 38, 3, 6, 3, 0, 37, 18, 1, 0, 0, 0, 37, 30, 1,
		0, 0, 0, 37, 36, 1, 0, 0, 0, 38, 5, 1, 0, 0, 0, 39, 40, 5, 16, 0, 0, 40,
		41, 5, 2, 0, 0, 41, 46, 3, 8, 4, 0, 42, 43, 5, 16, 0, 0, 43, 44, 5, 9,
		0, 0, 44, 46, 3, 8, 4, 0, 45, 39, 1, 0, 0, 0, 45, 42, 1, 0, 0, 0, 46, 7,
		1, 0, 0, 0, 47, 48, 6, 4, -1, 0, 48, 58, 5, 16, 0, 0, 49, 58, 5, 15, 0,
		0, 50, 58, 5, 14, 0, 0, 51, 52, 7, 0, 0, 0, 52, 58, 3, 8, 4, 4, 53, 54,
		5, 8, 0, 0, 54, 55, 3, 8, 4, 0, 55, 56, 5, 7, 0, 0, 56, 58, 1, 0, 0, 0,
		57, 47, 1, 0, 0, 0, 57, 49, 1, 0, 0, 0, 57, 50, 1, 0, 0, 0, 57, 51, 1,
		0, 0, 0, 57, 53, 1, 0, 0, 0, 58, 67, 1, 0, 0, 0, 59, 60, 10, 3, 0, 0, 60,
		61, 7, 1, 0, 0, 61, 66, 3, 8, 4, 4, 62, 63, 10, 2, 0, 0, 63, 64, 7, 2,
		0, 0, 64, 66, 3, 8, 4, 3, 65, 59, 1, 0, 0, 0, 65, 62, 1, 0, 0, 0, 66, 69,
		1, 0, 0, 0, 67, 65, 1, 0, 0, 0, 67, 68, 1, 0, 0, 0, 68, 9, 1, 0, 0, 0,
		69, 67, 1, 0, 0, 0, 8, 15, 25, 34, 37, 45, 57, 65, 67,
	}
...
const (
	...
	Lab2_GParserENBLANCO = 13
	Lab2_GParserENTERO   = 14
	Lab2_GParserDECIMAL  = 15
	Lab2_GParserID       = 16
	Lab2_GParserRETURN   = 17
	Lab2_GParserUL_C     = 18
)
...
func (p *Lab2_GParser) L_sentencias() (localctx IL_sentenciasContext) {
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&71680) != 0 {
		{
			p.SetState(12)
			p.Sentencia()
		}

...
// EnterIFsen is called when production IFsen is entered.
func (s *BasePCompi2NListener) EnterIFsen(ctx *IFsenContext) {}

// ExitIFsen is called when production IFsen is exited.
func (s *BasePCompi2NListener) ExitIFsen(ctx *IFsenContext) {}

// EnterSwitch is called when production switch is entered.
func (s *BasePCompi2NListener) EnterSwitch(ctx *SwitchContext) {}

// ExitSwitch is called when production switch is exited.
func (s *BasePCompi2NListener) ExitSwitch(ctx *SwitchContext) {}

// EnterCase is called when production case is entered.
func (s *BasePCompi2NListener) EnterCase(ctx *CaseContext) {}

// ExitCase is called when production case is exited.
func (s *BasePCompi2NListener) ExitCase(ctx *CaseContext) {}

// EnterDefaultc is called when production defaultc is entered.
func (s *BasePCompi2NListener) EnterDefaultc(ctx *DefaultcContext) {}

// ExitDefaultc is called when production defaultc is exited.
func (s *BasePCompi2NListener) ExitDefaultc(ctx *DefaultcContext) {}

// EnterBlock is called when production Block is entered.
func (s *BasePCompi2NListener) EnterBlock(ctx *BlockContext) {}

// ExitBlock is called when production Block is exited.
func (s *BasePCompi2NListener) ExitBlock(ctx *BlockContext) {}

// EnterSentenciaEj is called when production SentenciaEj is entered.
func (s *BasePCompi2NListener) EnterSentenciaEj(ctx *SentenciaEjContext) {}

// ExitSentenciaEj is called when production SentenciaEj is exited.
func (s *BasePCompi2NListener) ExitSentenciaEj(ctx *SentenciaEjContext) {}

// EnterSentenciaSwitch is called when production SentenciaSwitch is entered.
func (s *BasePCompi2NListener) EnterSentenciaSwitch(ctx *SentenciaSwitchContext) {}

// ExitSentenciaSwitch is called when production SentenciaSwitch is exited.
func (s *BasePCompi2NListener) ExitSentenciaSwitch(ctx *SentenciaSwitchContext) {}

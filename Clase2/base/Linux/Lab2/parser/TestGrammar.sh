...
java -jar ./antlr-4.13.0-complete.jar -o TestRig Lab2_G.g4
javac -cp ./antlr-4.13.0-complete.jar -g -Xlint  TestRig/Lab2*.java
java -cp ./antlr-4.13.0-complete.jar:./TestRig org.antlr.v4.gui.TestRig Lab2_G s -gui ./../entrada.txt

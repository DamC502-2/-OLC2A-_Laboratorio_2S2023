...
javac -cp .:/usr/share/java/antlr4.jar:/usr/share/java/antlr4-runtime.jar -g -Xlint  TestRig/Lab0*.java ;
java -cp .:./TestRig:/usr/share/java/antlr4.jar:/usr/share/java/antlr4-runtime.jar:/usr/share/java/treelayout.jar  org.antlr.v4.gui.TestRig Lab0_Parser s -gui ./TestRig/entrada.txt

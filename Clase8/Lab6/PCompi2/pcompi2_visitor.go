...
type PCompi2Visitor interface {
	...
	// Visit a parse tree produced by PCompi2Parser#marcador.
	VisitMarcador(ctx *MarcadorContext) interface{}

	// Visit a parse tree produced by PCompi2Parser#marcador2.
	VisitMarcador2(ctx *Marcador2Context) interface{}

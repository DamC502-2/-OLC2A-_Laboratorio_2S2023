...
var Lab1_GLexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	ChannelNames           []string
	ModeNames              []string
...
func lab1_glexerLexerInit() {
	staticData := &Lab1_GLexerLexerStaticData
...
// Lab1_GLexerInit initializes any static state used to implement Lab1_GLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLab1_GLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Lab1_GLexerInit() {
	staticData := &Lab1_GLexerLexerStaticData
	staticData.once.Do(lab1_glexerLexerInit)
}

// NewLab1_GLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLab1_GLexer(input antlr.CharStream) *Lab1_GLexer {
	Lab1_GLexerInit()
	l := new(Lab1_GLexer)
...
const (
	Lab1_GLexerPARDER   = 1
	Lab1_GLexerPARIZQ   = 2
	Lab1_GLexerENBLANCO = 3
	Lab1_GLexerENTERO   = 4
	Lab1_GLexerDECIMAL  = 5
	Lab1_GLexerID       = 6
	Lab1_GLexerRETURN   = 7
	Lab1_GLexerUL_C     = 8
)
